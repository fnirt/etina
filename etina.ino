 ...
 */
  ...
  Serial.print((String)" R: "+temp);               //Display the read value in the Serial monitor
  if (temp < 10 ) 
  {
    //noTone(Piezo);
  }
  ...
  //Serial.println("temp");               //Display the read value in the Serial monitor
  Serial.print((String)" L: " + temp);               //Display the read value in the Serial monitor
  if (temp <10000 ) 
  {
    //noTone(Piezo);
  }
...
void playsound(double note) {
    Serial.print((String)" N: "+note);               //Display the read value in the Serial monitor
